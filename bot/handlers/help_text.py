...
def build_help_text(chat_id: int) -> str:
    ...
    return (
        ...
        "/start — кратко о боте\n"
        "/help — эта справка\n"
        "У многих команд есть подменю с кнопками — набери /guess, /chance и т.д.\n\n"
        ...
        "/titles — твои титулы за ответы и победы\n"
        "/titles @ник — титулы участника\n"
        "/me — твоя карточка в чате\n\n"
        "/guess — мини-игра «угадай пародию» (3 раунда)\n"
        "/guess 5 — сессия из 5 раундов\n"
        "/guess score — лидерборд\n"
        "/guess stop — остановить игру\n\n"
        "/guessduel @ник — дуэль 1 на 1 (30 сек на ответ)\n"
        "/guessduel accept — принять дуэль\n"
        "/guessduel stop — отменить дуэль\n\n"
